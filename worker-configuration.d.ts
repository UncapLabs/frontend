/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fc5f7a91a99a9210594f88249e855214)
// Runtime types generated with workerd@1.20250902.0 2025-06-25 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		...
		SNAPSHOT_COLLECTOR: DurableObjectNamespace /* SnapshotCollectorDO from bitusd-app */;
		DB: D1Database;
		DOCS_WORKER: Fetcher /* uncap-docs */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "NODE_URL" | "GRAPHQL_ENDPOINT" | "ADMIN_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_API_TOKEN">> {}
}
