...
export function BridgeInfo() {
  ...
  const trigger = (
    <button
      className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white hover:bg-neutral-50 shadow-lg border border-neutral-200 flex items-center justify-center transition-all hover:scale-105"
      aria-label="Bridge Bitcoin info"
      title="How to bridge Bitcoin"
    >
      <Info className="h-6 w-6 text-[#006CFF]" />
    </button>
  );
        ...
        <div className="bg-neutral-50 rounded-xl p-6 space-y-4">
          ...
          <div>
            <p className="text-sm font-normal font-sora text-neutral-700 mb-4">
              Use Atomiq Exchange - a fully trustless cross-chain DEX for
              swapping between Bitcoin and Starknet
            </p>

            <div className="flex items-start gap-4">
              <img
                src="/xverse_wallet.webp.png"
                alt="Xverse Wallet"
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-normal font-sora text-neutral-600 ml-8">
                    Bridge wBTC directly, or bridge any token (like ETH) and
                    swap to wBTC on AVNU
                  </p>
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-8 sm:left-8 z-40">
        <Dialog>
          ...
          <DialogContent className="max-w-3xl">
            <DialogHeader>
              <DialogTitle>Bridge Bitcoin to Starknet</DialogTitle>
              <DialogDescription>
                Choose the best bridging method based on where your Bitcoin is
                located
              </DialogDescription>
            </DialogHeader>
            {content}
