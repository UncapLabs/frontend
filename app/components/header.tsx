...
function VaultIcon() {
  return (
    ...
    >
      <path
        d="M6.5 0C6.673 0 6.842 0.026 7.006 0.078L11.33 1.374C11.667 1.478 11.905 1.79 11.905 2.14V6.5C11.905 9.328 9.586 11.77 6.682 12.108C6.561 12.12 6.439 12.12 6.318 12.108C3.414 11.77 1.095 9.328 1.095 6.5V2.14C1.095 1.79 1.333 1.478 1.67 1.374L5.994 0.078C6.158 0.026 6.327 0 6.5 0ZM6.5 1.04C6.413 1.04 6.327 1.053 6.245 1.079L2.173 2.298C2.13 2.311 2.1 2.35 2.1 2.402V6.5C2.1 8.876 4.059 10.914 6.527 11.2C6.501 11.2 6.475 11.2 6.449 11.2C6.475 11.2 6.501 11.2 6.527 11.2C8.919 10.914 10.9 8.876 10.9 6.5V2.402C10.9 2.35 10.87 2.311 10.827 2.298L6.755 1.079C6.673 1.053 6.587 1.04 6.5 1.04ZM8.598 4.55L9.312 5.264L6.132 8.444L3.688 6.0L4.402 5.286L6.132 7.016L8.598 4.55Z"
        fill="currentColor"
      />
    </svg>
  );
