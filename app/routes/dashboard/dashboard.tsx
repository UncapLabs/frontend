    ...
    <div className="w-full mx-auto max-w-7xl py-8 px-4 sm:px-6 lg:px-8 min-h-screen">
      <div className="flex justify-between items-baseline">
        <div className="flex items-center gap-3">
          <h1 className="text-5xl font-medium font-sora mb-2 text-neutral-800 leading-tight">
            Dashboard
          </h1>
          {isRefetching && (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-600 mb-3">
                ...
                that {liquidatedTroves.length > 1 ? "were" : "was"} liquidated.
                You may have collateral surplus to claim.
              </p>
              <Button
                onClick={() => {
                  // Navigate to the liquidated page (no longer needs troveId)
