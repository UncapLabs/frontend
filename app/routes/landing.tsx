  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#003680]">
      ...
      <div className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 lg:p-16">
        ...
        {/* Bottom section with content split between left and right */}
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-[#fffbf5]">
                DO MORE WITH
                <span className="block text-[#ff9400]">BITCOIN</span>
              </h1>
            </div>
            ...
            >
              <a
                href="http://x.com/intent/user?screen_name=UncapFinance"
                target="_blank"
          ...
          <div className="lg:mb-8 w-full md:max-w-[480px] mx-auto lg:mx-0">
            <iframe
              src="https://uncap.substack.com/embed"
